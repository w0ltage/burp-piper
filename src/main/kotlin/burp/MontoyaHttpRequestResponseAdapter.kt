...
/**
 * Adapter class to bridge Montoya API HTTP message types with legacy Piper interfaces.
 * This allows existing Piper logic to work with the new Montoya API without requiring
 * complete rewrites of all message processing logic.
 */
class MontoyaHttpRequestResponseAdapter {
    ...
    /**
     * Get the request bytes in legacy format.
     * Compatible with legacy IHttpRequestResponse.getRequest() method.
     */
    ...
    /**
     * Get the response bytes in legacy format.
     * Compatible with legacy IHttpRequestResponse.getResponse() method.
     */
    ...
    /**
     * Set the request bytes - used for message modification.
     * Compatible with legacy IHttpRequestResponse.setRequest() method.
     */
    ...
    /**
     * Set the response bytes - used for message modification.
     * Compatible with legacy IHttpRequestResponse.setResponse() method.
     */
    ...
    /**
     * Get the HTTP service information.
     * Compatible with legacy IHttpRequestResponse.getHttpService() method.
     */
    ...
    /**
     * Set the HTTP service information.
     * Compatible with legacy IHttpRequestResponse.setHttpService() method.
     */
    ...
    /**
     * Get highlight color.
     * Compatible with legacy IHttpRequestResponse.getHighlight() method.
     */
    ...
    /**
     * Set highlight color.
     * Compatible with legacy IHttpRequestResponse.setHighlight() method.
     */
    fun setHighlight(color: String?) {
        ...
        // needs to be handled through the appropriate Montoya API methods
        color?.let {
            httpRequestResponse?.annotations()?.setHighlightColor(
    ...
    /**
     * Get comment.
     * Compatible with legacy IHttpRequestResponse.getComment() method.
     */
    ...
    /**
     * Set comment.
     * Compatible with legacy IHttpRequestResponse.setComment() method.
     */
     ...
     * Helper method to extract URL information from the HTTP request.
     */
    fun getUrl(): URL? {
        return try {
            request?.httpService()?.let { service ->
                val path = request.path()
                URL("${if (service.secure()) "https" else "http"}://${service.host()}:${service.port()}$path")
            }
        } catch (e: Exception) {
            null
        }
...
/**
 * Adapter for HTTP service information.
 * Bridges Montoya API HttpService with legacy IHttpService interface.
 */
class MontoyaHttpServiceAdapter(private val httpService: burp.api.montoya.http.message.HttpService) {
